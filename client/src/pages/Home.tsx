...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-white">
      ...
      <main>
        <Hero onAdminLogin={() => setLoginOpen(true)} />
        <StatsBar />
        <HowItWorks />
        <CardsSection cards={cards} loading={loadingCards} />
        <ServicesSection />
        <WhyUs />
        <AboutSection />
      </main>
...
/* ===================== HERO ===================== */
function Hero({ onAdminLogin: _onAdminLogin }: { onAdminLogin: () => void }) {
  return (
    <section
      id="home"
...
/* ===================== CARDS SECTION ===================== */
function CardsSection({ cards, loading }: { cards: GiftCard[]; loading: boolean }) {
  return (
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <AnimatedSection>
            <div>
              ...
              <h2 className="font-display text-3xl font-extrabold tracking-tight text-[#0A1224] sm:text-4xl lg:text-5xl">
                A premium platform, built on trust.
              </h2>
              <div className="mt-6 space-y-5 text-base leading-relaxed text-[#3B4256]">
                <p>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-xl bg-[#0047AB] px-6 py-3 text-sm font-semibold text-white hover:bg-[#002B6D] transition-colors"
                >
                  <MessageCircle className="h-4 w-4" />
                  Talk to us
                </a>
                <a
                  href="#cards"
                  className="inline-flex items-center gap-2 rounded-xl border border-[#E2E8F0] bg-white px-6 py-3 text-sm font-semibold text-[#0A1224] hover:border-[#0047AB]/30 transition-colors"
                >
                  See live rates
          ...
          <AnimatedSection delay={0.15}>
            <div className="relative">
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-[#0047AB]/10 to-[#C9A24B]/10 blur-2xl" />
              <div className="relative overflow-hidden rounded-3xl border border-[#E2E8F0] bg-gradient-to-br from-[#002B6D] via-[#0047AB] to-[#1E5BD6] p-8 text-white shadow-2xl">
                <div className="absolute inset-0 bg-grid-dark opacity-30" />
                ...
                <div className="relative">
                  ...
                  <ul className="mt-6 space-y-4">
                    {[
                      ...
                      >
                        <div className="mt-1 flex h-5 w-5 flex-none items-center justify-center rounded-full bg-white/15 ring-1 ring-white/20">
